...
export const articles: Article[] = [
  { id: 1, slug: "ai-video-trends-2026", title: "LX Engine 파인튜닝으로 브랜드 일관성 96% 달성하는 법", summary: "LoRA 기반 자체 파인튜닝 기술로 브랜드 맞춤 영상 일관성을 극대화한 실전 방법론을 공개합니다.", tag: "AI 영상 트렌드", date: "2026.02.15", featured: true, ctaType: "production" },
  { id: 2, slug: "ai-video-marketing-performance", title: "Sora vs Runway vs LX Engine — 브랜드 영상 품질 비교 테스트", summary: "주요 AI 영상 생성 모델의 브랜드 일관성, 품질, 속도를 실제 프로젝트 기준으로 비교 분석합니다.", tag: "마케팅 전략", date: "2026.02.10", featured: true, ctaType: "production" },
