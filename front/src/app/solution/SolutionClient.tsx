  ...
  return (
    <>
      ...
      <SectionContainer className="bg-white pt-24 pb-20 dark:bg-slate-950">
          <div className="max-w-3xl">
            ...
            >
              <a
                ...
                className="inline-flex h-12 items-center justify-center rounded-lg bg-secondary-600 px-8 text-sm font-semibold text-white transition-colors hover:bg-secondary-700"
              >
                {t.solution.cta}
              </a>
            </motion.div>
          ...
          <div className="mt-16 overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-secondary-50 to-slate-100 shadow-lg dark:border-slate-800 dark:from-secondary-950/30 dark:to-slate-900">
              ...
              <div className="flex h-80 items-center justify-center bg-gradient-to-br from-secondary-100/50 to-slate-50 dark:from-secondary-950/20 dark:to-slate-900">
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-secondary-100 dark:bg-secondary-900/50">
                    <svg className="h-8 w-8 text-secondary-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
