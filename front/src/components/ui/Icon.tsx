...
/* ── YouTube ── */
export function IconYouTube({ className = "h-5 w-5" }: Omit<IconProps, "strokeWidth">) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
/* ── Instagram ── */
export function IconInstagram({ className = "h-5 w-5" }: Omit<IconProps, "strokeWidth">) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
/* ── LinkedIn ── */
export function IconLinkedIn({ className = "h-5 w-5" }: Omit<IconProps, "strokeWidth">) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
/* ── X (Twitter) ── */
export function IconX({ className = "h-5 w-5" }: Omit<IconProps, "strokeWidth">) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
