    ...
    <>
      ...
      <SectionContainer className="bg-slate-50 py-24 dark:bg-slate-900">
          ...
          <div className="relative mt-12">
            {/* Timeline Line */}
            <div className="absolute left-4 top-0 h-full w-0.5 bg-blue-200 dark:bg-blue-800 sm:left-1/2 sm:-translate-x-px" />
            ...
            <div className="space-y-8">
              {t.story.timeline.map((item, i) => (
                ...
                >
                  {/* Dot */}
                  <div className="absolute left-4 top-2 z-10 h-3 w-3 -translate-x-1/2 rounded-full border-2 border-blue-600 bg-white dark:border-blue-400 dark:bg-slate-900 sm:left-1/2" />
            ...
            {t.story.team.map((member) => (
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-950">
                  <span className="text-xl font-bold text-blue-500 dark:text-blue-400">{member.name[0]}</span>
                </div>
